...
<head>
  ...
  <title>BUSCADORES DE EMPLEO :: SECRETARIA DE ECONOMIA :: NAVOJOA</title>
...
.bg-gray-900 {
  --tw-bg-opacity: 1;
  background-color: rgb(81 20 20 / var(--tw-bg-opacity));
}
.bg-green-500 {
  --tw-bg-opacity: 1;
...
.text-gray-700 {
  --tw-text-opacity: 1;
  color: rgb(255 252 199 / var(--tw-text-opacity));
}
.text-white {
  --tw-text-opacity: 1;
